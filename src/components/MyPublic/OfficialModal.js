...
import { Modal, Form, Input, InputNumber, Button, Select, DatePicker, Row, Col, Checkbox, notification, Tabs} from 'antd';
...
class MyModal extends Component {
    ...
    render() {
        ...
        // console.log('this.props.recordId', this.props.recordId)
        return (
            <div>
                <Modal {...t.props}
